...
import { View, Text, ScrollView, Image, FlatList, Button, TouchableOpacity, Modal, ToastAndroid, TextInput } from 'react-native';
...
import { Get_Tables, Dine_Order, Pos_sell_end, TABLE_COUNT, MULTITABLEFREE, GET_RESERVATION, SAVE_RESERVATION } from '../utils/urls';
...
const MainDashboard = (props) => {
  ...
  const { fun, stf_name, saleClose, select, stf_id, loc_id, loaded } = useSelector((state) => state.root.main);
  // MAin TAB BAR
  ...
  const btn1 = () => <Text style={{ fontWeight: 'bold', fontSize: wp('1.5%'), color: 'white', marginRight: 10, fontFamily: 'Roboto' }}>DINING</Text>
  const btn2 = () => <Text style={{ fontWeight: 'bold', fontSize: wp('1.5%'), color: 'white', marginLeft: 10, fontFamily: 'Roboto' }}>TAKEAWAY</Text>
  const btn3 = () => <Text style={{ fontWeight: 'bold', fontSize: wp('1.5%'), color: 'white', marginLeft: 10, fontFamily: 'Roboto' }}>DELIVERY</Text>
  const btn4 = () => <Text style={{ fontWeight: 'bold', fontSize: wp('1.5%'), color: 'white', marginLeft: 10, fontFamily: 'Roboto' }}>PICKUP</Text>
  ...
  const bt3 = () => <Text style={{ fontWeight: '600', fontSize: wp('1%'), color: 'black', opacity: 0.4, fontFamily: 'Roboto' }}>FIRST FLOOR</Text>
  const bt2 = () => <Text style={{ fontWeight: '600', fontSize: wp('1%'), color: 'black', opacity: 0.4, fontFamily: 'Roboto' }}>SECOND FLOOR</Text>
  const bt1 = () => <Text style={{ fontWeight: '600', fontSize: wp('1%'), color: 'black', opacity: 0.4, fontFamily: 'Roboto' }}>OUTDOOR</Text>
  ...
  const reload = () => {
    ...
    // console.log("DISpatch ho reha ha");
  }
            ...
            <View style={styles.modalView}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  const obj = { 'table_id': item.key, 'order_id': item.order_id }
                  Tableid.push(obj)


                  // console.log("merged Tavles 2 ==", Tableid)
                  return (
                ...
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 0.3, borderRightWidth: 1 }}>
                    ...
                    {sbtn == 0 ? <>
                      ...
                      {/* <TouchableOpacity style={{ flexDirection: 'row', width: wp('28%'), borderRadius: 5, height: hp('6%'), borderWidth: 1, alignSelf: 'center', justifyContent: 'center', marginBottom: wp('2%') }}>
  ...
  >
    <Text style={{ padding: 2, fontSize: wp('1%'), alignSelf: 'center', color: 'red' }}>
      {mergedTables2.length > 0 ? "Done" : "Free Tables"}
          ...
          : sel == 1 ? <TakeawayOrder T_order_id={t_order_id} mergedTables={mergedTables} Pass='table' br={br} Table={table} pass="Main" table_pass={table_condi} Count={count} Table_Id={table_id} userId={Key} response={res} /> : sel == 2 ? <Delivery /> : sel == 3 ? <Pickup /> :
