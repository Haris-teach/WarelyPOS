    ...
    <>
      {state == 'Pay' ? (
        <Pay
          ...
          ExtCallback={props.ExtCallback}
          ExtCallback1={props.ExtCallback1}
          product_id={props.product_id}
          btn={props.btn}
          variantCallback={props.variantCallback}
          reload={props.reload}
          addNewItem={props.addNewItem}
          branch={props.branch}
          Cat_id={props.Cat_id}
          refresh={props.refresh}
          T_order_sum={props.T_order_sum}
          pass="Payable"
          Cat_id={props.Cat_id}
          D={props.D}
          branch={props.branch}
        ...
        <>
          <View
            ...
            <View
              ...
              <Text
                style={{color: 'gray', fontSize: wp('1%'), fontWeight: '700'}}>
                Selected Option:{' '}
              </Text>
              <Text
                style={{color: 'black', fontSize: wp('1%'), fontWeight: '700'}}>
                {payName}
              </Text>
            </View>
          </View>
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                backgroundColor: btn == 0 ? 'gray' : '#FC3F3F',
                alignItems: 'center',
                borderRadius: 5,
                justifyContent: 'center',
                height: hp('7.5%'),
