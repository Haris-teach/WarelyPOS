      ...
      <>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text
              style={[styles.textStyle, {alignSelf: 'center', color: 'red'}]}>
              ...
              <Text>
                {item.pro_dis == 0 ? (
                  <TouchableOpacity
                    ...
                    <Text style={{fontSize: wp('2.8%'), marginTop: hp('-1%')}}>
                      +
                    </Text>
                  </TouchableOpacity>
                ) : (
      ...
      {state == 'Profile' ? (
        ...
        <>
          ...
          <Modal
            ...
            <View
              style={[styles.modalView, {width: wp('20%'), height: hp('50%')}]}>
              <TouchableOpacity
                style={{
                  justifyContent: 'center',
                  alignItems: 'center',
              ...
              <View
                ...
                <Text
                  ...
                  ARE YOU SURE, YOU WANT TO CLEAR THE MENU?
                </Text>
                <TouchableOpacity
                  style={{
                    backgroundColor: 'red',
                  ...
                  <Text style={{color: 'white', fontSize: wp('1.3%')}}>
                    CONFIRM
                  </Text>
                </TouchableOpacity>
              </View>
                ...
                <>
                  ...
                  <View
                    ...
                    <View
                      style={[
                        styles.viewStyle,
                        {alignItems: 'flex-start', width: wp('22.95%')},
                      ]}>
                      <Text
                        style={[
                          styles.textStyle,
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    justifyContent: 'center',
                    marginRight: wp('0%'),
                    backgroundColor: array.length == 0 ? 'gray' : '#FC3F3F',
                    height: hp('7%'),
                  }}
                  onPress={() => {
                          ...
                          <View
                            ...
                            <TouchableOpacity
                              onPress={() => {
                                ...
                                dispatch(
                                  SetTotal2(p + parseInt(price) * paxCount),
                                );
                              }}
                              style={{
                                alignSelf: 'center',
