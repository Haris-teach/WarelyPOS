...
const Pin = ({ navigation, route }) => {
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: 'rgb(250,250,250)' }}>
      <View style={{ marginLeft: 10, justifyContent: 'flex-start', marginTop: '3%' }}>
        <Image
      ...
      <View style={styles.container1}>
        ...
        >
          <Text style={{ fontWeight: 'bold', fontSize: wp('1.5%') }}>Enter PIN</Text>
        </View>
        ...
        <ScrollView>
          <Animatable.View
            ...
            duration={1500}
            style={{ height: hp('120%'), marginTop: 10, alignSelf: 'center', borderRadius: 5 }}
          >


            <View style={{ flexDirection: 'row', width: wp('98%'), backgroundColor: 'red', borderTopWidth: 1, borderColor: "#b5b5b5", }}>

              <TouchableOpacity style={{ width: wp('20%'), backgroundColor: 'white', height: 100, justifyContent: 'center', borderRightWidth: 1, borderColor: "#b5b5b5", }}
                onPress={() => {
                  { p1 === "white" ? setP1("red") : p2 === "white" ? setP2("red") : p3 === "white" ? setP3("red") : p4 === "white" ? setP4("red") : null }
                  concatinate('1');
                }}>
              ...
              <TouchableOpacity style={{ width: wp('20.3%'), backgroundColor: 'white', height: 100, justifyContent: 'center', borderColor: "#b5b5b5", }}
                onPress={() => {
                  { p1 === "white" ? setP1("red") : p2 === "white" ? setP2("red") : p3 === "white" ? setP3("red") : p4 === "white" ? setP4("red") : null }
                  concatinate('3');
                }}>
            ...
            <View style={{ flexDirection: 'row', width: wp('98%'), borderTopWidth: 1, backgroundColor: 'red', borderColor: "#b5b5b5", }}>
              ...
              <TouchableOpacity style={{ width: wp('20.3%'), backgroundColor: 'white', height: 100, justifyContent: 'center', }}
                onPress={() => {
                  { p1 === "white" ? setP1("red") : p2 === "white" ? setP2("red") : p3 === "white" ? setP3("red") : p4 === "white" ? setP4("red") : null }
                  concatinate('6');
                }}>
            ...
            <View style={{ flexDirection: 'row', width: wp('98%'), backgroundColor: 'red', borderTopWidth: 1, marginBottom: 5, borderBottomWidth: 1, borderColor: "#b5b5b5", }}>


              <TouchableOpacity style={{ width: wp('20%'), backgroundColor: 'white', height: 99, justifyContent: 'center', borderRightWidth: 1, borderColor: "#b5b5b5", }}
                onPress={() => {
                  setP1("white");
                  setP2("white");
                  setP3("white");
              ...
              <View style={{ width: wp('20.3%'), backgroundColor: 'white', height: 99, justifyContent: 'center', }}>
