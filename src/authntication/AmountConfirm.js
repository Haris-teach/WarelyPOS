...
import { Call, SetPoss_end, Stf_id, SetLoaded, SetFloat_price } from '../Redux/Reducers/mainReducer';
...
const AmountConfirm = ({ navigation, route }) => {
  ...
  const { s_id, loaded } = useSelector((state) => state.root.main);
