                    ...
                    <View style={{ borderLeftWidth: 1, borderColor: 'gray', flex: 1 }}>
                        ...
                        <View style={[styles.containerStyle, { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: hp('25%') }]}>
                            ...
                            <View style={{
                                ...
                                <Text style={{ color: 'black', alignSelf: 'center', fontWeight: 'bold', fontSize: wp('1.8%') }}>$  {parseFloat(Total).toFixed(2)}
                        ...
                        <View style={{ flexDirection: 'row', height: hp('12%'), width: wp('40%'), backgroundColor: 'white', }}>
                            ...
                            <TouchableOpacity disabled={parseFloat(V).toFixed(2) < 0 ? true : false} style={{ width: wp('26%'), backgroundColor: parseFloat(V).toFixed(2) < 0 ? 'gray' : '#FF2E2E', height: hp('12.3%'), justifyContent: 'center' }}
                                onPress={() => {
