...
import {Add_print} from '../utils/urls';
const And = () => {
  ...
  const callAddPrinterAPI = () => {
    // let params = {
    //     Loc_id: loc_id,
    //     Cat_id: props.Cat_id,
    // };
    setLoading(true);
    APIHandler.hitApi(Add_print, 'POST').then(response => {
          ...
          <ScrollView style={styles.scrolView}>
            <View style={styles.flexStyle}>
              ...
              {box == '1' ? (
                ...
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('1')}></TouchableOpacity>
              )}
              <Text style={styles.checkBoxText}>No Category</Text>
            </View>

            <View style={styles.flexStyle}>
              <TextInput style={styles.inputBox} placeholder="Printer Type" />
              {box == '2' ? (
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('2')}>
                ...
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('2')}></TouchableOpacity>
              )}
              <Text style={styles.checkBoxText}>Drinks</Text>
            </View>

            <View style={styles.flexStyle}>
              <TextInput style={styles.inputBox} placeholder="Printer Model" />
              {box == '3' ? (
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('3')}>
                ...
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('3')}></TouchableOpacity>
              )}
            ...
            <View style={styles.flexStyle}>
              ...
              {box == '4' ? (
                ...
                <TouchableOpacity
                  style={styles.checkBox}
                  onPress={() => setBox('4')}></TouchableOpacity>
              )}
              <Text style={styles.checkBoxText}>Sides</Text>
            </View>

            <TextInput style={styles.inputBox} placeholder="Paper Type" />
          </ScrollView>
