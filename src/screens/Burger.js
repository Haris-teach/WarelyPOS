                ...
                {state == true ?
                    ...
                    : <FlatList
                        ...
                        renderItem={({ item }) => (
                            ...
                            <TouchableOpacity style={{ width: wp('12%'), height: hp('18%'), backgroundColor: 'rgb(240,240,240)', marginRight: '2%', marginBottom: '1%', marginTop: hp('5%'), borderRadius: 4, justifyContent: 'flex-end' }}
                                onPress={() => {
                                    if (item.type === 'single') {
                                        props.addNewItem(item.name, item.price, item.discount, item.id, item.var_id)
                                    } else {
